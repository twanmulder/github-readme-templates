...
export default function ReadmeList(props) {
  ...
  return readmes.map((readme, index) => {
    return (
      <article key={readme.APIurl} className="w-full p-4">
        ...
        >
          ...
          <a
            ...
            data-splitbee-event={`view-user-github-${index}`}
          ...
          <div className="flex flex-col	md:flex-row justify-center md:justify-end">
            <button
              ...
              data-splitbee-event={`preview-${index}`}
            ...
            <button
              ...
              data-splitbee-event={`copy-markdown-${index}`}
            ...
            <a
              ...
              data-splitbee-event={`view-on-github-${index}`}
